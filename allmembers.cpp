...
AllMembers::AllMembers(QString Name, QString Number, QString Email, QString one,QString two,QString three) // double fine
{
    this->Name = Name;
    this->Number = Number;
    this->Email = Email;
...
//void AllMembers::setFine(double fine)
//{
//    Fine=fine;
//}
//double AllMembers::getFine() const
//{
//    return Fine;
//}
