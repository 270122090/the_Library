...
public:
    ...
    void setupUi(QDialog *login)
    {
        ...
        frame_2->setGeometry(QRect(145, 141, 471, 441));
...
"border-radius:none;"));
        ...
        labelAstronaut->setGeometry(QRect(155, 141, 71, 71));
        ...
        toolButton->setGeometry(QRect(130, 120, 121, 121));
