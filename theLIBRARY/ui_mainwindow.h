...
"color: red;"));
        ...
        widget->setGeometry(QRect(10, 120, 341, 251));
        gridLayout = new QGridLayout(widget);
        gridLayout->setObjectName(QString::fromUtf8("gridLayout"));
        gridLayout->setContentsMargins(0, 0, 0, 0);
        lblDewey = new QLabel(widget);
        ...
        lblBookTitle = new QLabel(widget);
...
"color: white;"));
        ...
        btnIssueBook = new QPushButton(widget2);
...
"color: white;"));
        ...
        btnSearchBook = new QPushButton(widget2);
